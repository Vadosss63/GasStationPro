...
void SettingWindows::setGasTypes(
    std::array<SendData::GasType, countColum> gasTypes) {
  for (int i = 0; i < countColum; ++i) {
...
void SettingWindows::createWidget() {
  ...
  gasType = {SendData::GasType::DT,      SendData::GasType::Gas92,
             SendData::GasType::Gas95,   SendData::GasType::Gas98,
             SendData::GasType::Methane, SendData::GasType::Propane};
  ...
  connect(m_resetCountersPushButton, SIGNAL(clicked()), this,
